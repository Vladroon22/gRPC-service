...
func (x *ClientText) GetText() string {
	if x != nil {
		return x.Text
	}
	return ""
...
func (x *ServerText) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ServerText) ProtoMessage() {}

func (x *ServerText) ProtoReflect() protoreflect.Message {
	mi := &file_add_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ServerText.ProtoReflect.Descriptor instead.
func (*ServerText) Descriptor() ([]byte, []int) {
	return file_add_proto_rawDescGZIP(), []int{1}
}

func (x *ServerText) GetResponse() string {
	if x != nil {
		return x.Response
	}
	return ""
...
var file_add_proto_rawDesc = []byte{
	,
...
var file_add_proto_goTypes = []interface{}{
	(*ClientText)(nil), // 0: ClientText
	(*ServerText)(nil), // 1: ServerText
}
var file_add_proto_depIdxs = []int32{
	0, // 0: Server.BroadCast:input_type -> ClientText
	1, // 1: Server.BroadCast:output_type -> ServerText
